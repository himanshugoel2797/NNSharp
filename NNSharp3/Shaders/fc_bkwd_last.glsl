...
layout(bindless_image) uniform writeonly image2D o; //input
layout(bindless_image) uniform writeonly image2D a; //input

//expected output as an input
//compute the loss function
//compute the delta for each weight and bias in this layer as output
